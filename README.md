...
|---|---|---|---|
| Пилот | Llama 3.3 70B через NVIDIA NIM API | нет, облачный API | доли тенге за вопрос; сводка раз в день |
| Внедрение on-prem | Qwen2.5-14B или Llama 3.1 8B (для tool calling достаточно) в vLLM/Ollama, 4-bit | 1 GPU 24–48 ГБ (RTX 4090 / L4 / L40S), обычный сервер | один сервер, данные не покидают компанию |

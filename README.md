...
- [x] Импортёр реальных выгрузок 1С партнёра (IEK, Systeme Electric): 12 файлов → формат движка одной командой
